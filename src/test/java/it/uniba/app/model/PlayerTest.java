...
class PlayerTest {
    ...
    /**
     * <Code>Player</Code> test utilizzato all'interno dei test della classe, inizializzato con il colore
     * <Code>Color.BLACK</Code> e il nome "Giocatore 1".
     */
     ...
     * <code>Player</code>, non corrisponda all'istanza di <code>Player</code> in ingresso al costruttore stesso.
     */
    private static final String WRONG_COPY = "La copia del giocatore eseguita non corrisponde al giocatore copiato.";

    /**
     * Messaggio d'errore nel caso in cui il colore del <code>Player</code> in esame non corrisponda a quello previsto.
     */
    private static final String WRONG_COLOR = "Il colore del giocatore non corrisponde a quello atteso.";
    ...
    /**
     * Valore hash di testPlayer con colore <code>Color.BLACK</code> e nome "Giocatore 1".
     */
    private static final int HASH_BLACK_PLAYER_ONE = -628335851;


    /**
     * Test del costruttore di copia della classe <Code>Player</Code>, per cui viene inizializzato un nuovo giocatore
     * con gli stessi valori degli attributi contenuti all'interno di testPlayer, e su questi viene eseguito il test.
     */
    @Test
    ...
    @Test
    void testHashCode() {
        assertEquals(HASH_BLACK_PLAYER_ONE, testPlayer.hashCode(), WRONG_HASH);
    }
